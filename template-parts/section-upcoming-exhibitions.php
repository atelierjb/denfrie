...
if ($query->have_posts()) :
    while ($query->have_posts()) : $query->the_post();
        ...
        <section class="pb-sp8 sm:pb-sp10">
            ...
            <div class="w-fit hover:text-df-red">
                ...
                <p class="-ml-[1px] sm:-ml-[2px] font-superclarendon text-xxl/xxl">
                <a href="<?php echo esc_url($post_url); ?>">
    ...
    echo '<p class="font-superclarendon text-xl/xl px-sp9">' . pll__('No upcoming exhibitions found.', 'tailpress') . '</p>';
