...
<main class="mx-sp3 my-sp5" id="main-content">
    <article class="columns-1 sm:columns-2 gap-sp1 pr-sp2">
            <section class="w-full pb-sp8">
                ...
                <div class="columns-2 gap-x-4 font-superclarendon text-regular/regular w-full sm:w-[calc(90%+1vw)]">
            ...
            <figure class="w-full px-sp5 sm:px-0 sm:w-[calc(90%+1vw)] hidden sm:block break-after-avoid sm:break-after-column pb-sp8 animateOnView">
                <?php 
            ...
            <figure class="w-full px-sp5 sm:px-0 sm:w-[calc(90%+1vw)] hidden sm:block pb-sp8 animateOnView">
                <?php 
            ...
            <?php if( have_rows('about-right') ): ?>
                ...
                <?php endwhile; ?>
            <?php endif; ?>
            <figure class="w-full px-sp5 sm:hidden pb-sp9 animateOnView">
                <?php 
                    $about_image_1_id = get_field('about-image-1'); 
                    if( $about_image_1_id ) : ?>
                        <?php echo wp_get_attachment_image( $about_image_1_id, 'full', false, array(
