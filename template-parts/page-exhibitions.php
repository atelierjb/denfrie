...
<main data-barba="container" data-barba-namespace="exhibitions" class="mx-sp3 my-sp5" id="main-content">
    <section class="w-full">
        <h2 class="font-dfserif text-large/large sm:text-xl/xl pb-sp5 sm:pb-sp7">
    ...
    <section class="w-full">
        <div class="flex justify-between">
            ...
            <h2 class="font-dfserif text-large/large sm:text-xl/xl pb-sp7 text-df-grey">
        ...
        <p class="font-dfserif text-large/large sm:text-xl/xl py-sp7">
            <a href="<?php echo get_permalink(pll_get_post(159)); ?>" class="hover:text-df-red">
