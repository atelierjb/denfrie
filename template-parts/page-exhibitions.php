...
<main data-barba="wrapper" class="mx-sp3 my-sp5" id="main-content">
    <article data-barba="container">
        <section class="w-full">
            <h2 class="font-dfserif text-xl/xl pb-sp5 sm:pb-sp7 animateOnView">
        ...
        <section class="w-full">
            <div class="flex justify-between">
                ...
                <h2 class="font-dfserif text-xl/xl pb-sp7 text-df-grey animateOnView">
            ...
            <p class="font-dfserif text-xl/xl py-sp7 animateOnView">
                <a href="<?php echo get_permalink(pll_get_post(159)); ?>" class="hover:text-df-red">
